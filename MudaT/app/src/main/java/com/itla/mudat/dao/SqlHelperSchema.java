...
public class SqlHelperSchema {
    ...
    public static final String ANUNCIO_TABLE = "CREATE TABLE Anuncio ( id	INTEGER PRIMARY KEY AUTOINCREMENT, fecha DATE NOT NULL, condicion TEXT NOT NULL, precio	DOUBLE NOT NULL, titulo	VARCHAR ( 50 ) NOT NULL ,ubicacion	VARCHAR ( 80 ) NOT NULL, detalle	TEXT NOT NULL, idCategoria	INTEGER NOT NULL, idUsuario	INTEGER NOT NULL); ";
